...
async def welcome(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    markup = [[
        InlineKeyboardButton("Confirm your identification here",
                             url="https://t.me/tgspamcleanserbot?start=start")
    ]]
    reply_markup = InlineKeyboardMarkup(markup)
    ...
    await update.message.reply_text(f"Welcome {each_username}. Go here ⏬",
                                    reply_markup=reply_markup)
